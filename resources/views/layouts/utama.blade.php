        ...
        <div class="d-flex">
            ...
            <aside>
                ...
                <ul class="menu-items">
                    ...
                    <li><a href="{{ route('dokumen.index') }}"><span class="icon fa fa-user"></span><span class="item-name">Dokumen</span></a><span class="tooltip">Dokumen</span></li>
                    <li><a href="{{ route('history.index') }}"><span class="icon fa fa-gear"></span><span class="item-name">CatatanBimbingan</span></a><span class="tooltip">CatatanBimbingan</span></li>
