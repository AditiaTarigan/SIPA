...
<body>
    ...
    <aside>
        ...
        <ul class="menu-items">
            ...
            <li><a href="{{ route('dokumen.index') }}"><span class="icon fa fa-file-upload icon"></span><span class="item-name">Log Activity   </span></a><span class="tooltip">LogActivity</span></li>
            <li><a href="#"><span class="icon fa fa-chart-line"></span><span class="item-name"> SubmitDokumen</span></a><span class="tooltip">SubmitDokumen</span></li>
