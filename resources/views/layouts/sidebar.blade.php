...
<body>
    ...
    <aside>
        ...
        <ul class="menu-items">
            ...
            <li><a href="{{ route('dokumen.index') }}"><span class="icon fa fa-chart-line"></span><span class="item-name"> SubmitDokumen</span></a><span class="tooltip">SubmitDokumen</span></li>
