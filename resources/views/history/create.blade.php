...
<form action='{{ url('history') }}' method='post'>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='hasil' value="{{Session::get('hasil')}}" id="hasil">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" name='tanggal2' value="{{Session::get('tanggal2')}}" id="tanggal2">
            </div>
        </div>
